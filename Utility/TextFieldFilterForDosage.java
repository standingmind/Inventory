...
public class TextFieldFilterForDosage extends DocumentFilter {
	...
	public TextFieldFilterForDosage (int type,JTextField tfLeadTime,JComboBox comboCycle,JTextField tfPremeasure,JTextField tfSafeStock){
		this.type = type;
		this.tfLeadTime = tfLeadTime;
	...
	public int getLeadTime(){
		String leadTime = tfLeadTime.getText();
		if(leadTime.toString().equals("") || leadTime.toString().equals(null)){
			return 0;
		}
      ...
      if (test(sb.toString())) {
          ...
          if(sb.toString().equals("") || sb.toString().equals(null)){
         	 dosage = 0;
         	  ...
         	  dosage = (Integer.parseInt(sb.toString()));
          }
